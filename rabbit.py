...
backgroundImage = pygame.image.load("assets/garden.jpg")
backgroundImageRect = backgroundImage.get_rect()
backgroundImageRect.bottom = WINDOW_HEIGHT

rabbitLeftImage = pygame.image.load("assets/rabbit_left.png")
rabbitRightImage = pygame.image.load("assets/rabbit_right.png")
playerImage = rabbitLeftImage
playerRect = playerImage.get_rect()
playerRect.centerx = WINDOW_WIDTH//2
playerRect.bottom = WINDOW_HEIGHT

carrotImage = pygame.image.load("assets/carrot.png")
...
titleFont = pygame.font.Font("assets/Shadow.ttf", 70)
hudFont = pygame.font.Font("assets/slum.ttf", 40)
endFont = pygame.font.Font("assets/Celosia.otf", 40)
welcomeFont = pygame.font.Font("assets/regular.ttf", 150)
